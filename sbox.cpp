...
int main()
{
  int S[8][64]=
  {
    ...
    while(lol <= 65430)
    {
      ...
      long long int t1=(long long int) strtoll(temp1,(char **)NULL,2);
      long long int t2=(long long int) strtoll(temp2,(char **)NULL,2);
      long long int t3=(long long int) strtoll(temp3,(char **)NULL,2);
